...
def stat_plotter(df, i):
    ...
    plt.gcf()
    plt.savefig('/Users/main/Downloads/OrDistance' + str(i) + '.png')
    plt.close()
    plt.figure(figsize=(5, 5))
    ax = plt.axes()
    ...
    plt.gcf()
    plt.savefig('/Users/main/Downloads/DestDistance' + str(i) + '.png')
    plt.close()
    plt.figure(figsize=(5, 5))
    ax = plt.axes()
    ...
    plt.gcf()
    plt.savefig('/Users/main/Downloads/DistCom' + str(i) + '.png')
    plt.close()
    plt.figure(figsize=(5, 5))
    ax = plt.axes()
    ...
    ax.set_ylabel('Commuters')
    plt.gcf()
    plt.savefig('/Users/main/Downloads/DestCom' + str(i) + '.png')
    plt.close()
    plt.figure(figsize=(5, 5))
    ax = plt.axes()
    ...
    ax.set_ylabel('Commuters')
    plt.gcf()
    plt.savefig('/Users/main/Downloads/OrCom' + str(i) + '.png')
    plt.close()
